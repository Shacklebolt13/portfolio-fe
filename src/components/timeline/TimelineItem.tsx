...
const TimelineItem: React.FC<TimelineItemProps> = ({
    ...
    // On medium and smaller screens we always show items on the right
    return (        <a 
            href={href} 
            className={`flex items-center relative 
                ${position === 'left' ? 
                    'justify-end pr-6 sm:pr-8 lg:pr-0' : 
                    'justify-start pl-6 sm:pl-8 lg:pl-0'
                } 
            ...
            tabIndex={0}
        >
            {/* Timeline content - conditionally positioned based on screen size */}            <motion.div
                className={`${
                    // On large screens: respect alternating positions with appropriate spacing
                    // On medium and smaller: always positioned to the right of the line
                    position === 'left' ? 
            ...
            >
                ...
                {/* Content card with glass effect */}                <div className="backdrop-blur-md bg-content1/25 p-4 sm:p-5 md:p-6 rounded-lg 
